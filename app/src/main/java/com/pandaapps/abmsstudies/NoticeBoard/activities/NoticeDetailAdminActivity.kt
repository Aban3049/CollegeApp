...
import com.pandaapps.abmsstudies.NoticeBoard.adapter.AdapterAdminNotice
...
import com.pandaapps.abmsstudies.databinding.ActivityNoticeDetailAdminBinding

class NoticeDetailAdminActivity : AppCompatActivity() {
        ...
        binding.searchEt.addTextChangedListener(object : TextWatcher {
            ...
            override fun onTextChanged(s: CharSequence?, start: Int, before: Int, count: Int) {
                try {
                    ...
                    Utils.toast(
                        this@NoticeDetailAdminActivity,
    ...
    private fun loadNotices() {
        ...
        ref.addValueEventListener(object : ValueEventListener {
            ...
            override fun onDataChange(snapshot: DataSnapshot) {
                ...
                //set adapter
                adapterAdminNotice =
                    AdapterAdminNotice(this@NoticeDetailAdminActivity, noticeAdminArrayList)
